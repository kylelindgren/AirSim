...
client.moveByVelocityZ(vx,vy,z,duration, 1, YawMode(False, 90))
time.sleep(delay)
vx = 0
vy = speed
print("moving by velocity vx=" + str(vx) + ", vy=" + str(vy)+ ", yaw=180")
client.moveByVelocityZ(vx,vy,z,duration, 1, YawMode(False, 180))
time.sleep(delay)
vx = -speed
vy = 0
print("moving by velocity vx=" + str(vx) + ", vy=" + str(vy)+ ", yaw=270")
client.moveByVelocityZ(vx, vy, z,duration, 1, YawMode(False, 270))
time.sleep(delay)
vx = 0
vy = -speed
print("moving by velocity vx=" + str(vx) + ", vy=" + str(vy) + ", yaw=0")
client.moveByVelocityZ(vx, vy,z,duration, 1, YawMode(False, 0))
time.sleep(delay)
client.hover()
