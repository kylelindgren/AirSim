...
ip = "127.0.0.1"
client = msgpackrpc.Client(msgpackrpc.Address(ip, 41451), timeout = 3600)
...
if __name__ == '__main__':
    ...
    # Connect to the game
    # client.connect()
    if not client:  # Check if the connection is successfully established
        ...
        for i in range(num_samples):
            ...
            write_pfm(disparity_filename, disparity.astype('float32'))
